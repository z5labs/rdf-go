...
// Turtle has no syntax for it. Writing the tag without the direction would
...
// Print writes doc to w as Turtle.
//
...
// "( ... )" and a blank node described in place as "[ ... ]". What the
// document meant by any of that is [Decode]'s business, not this function's.
//
...
// written inside a statement follows it rather than interrupting it: the
// layout it was written against is gone, and there is no longer anywhere
// inside a statement for it to stand.
//
...
// Encode writes triples to w as Turtle.
//
