...
// collections and blank node property lists nest, so a mutation that adds a
// bracket adds a level of recursion, and the parser has to end rather than
// descend for as long as the brackets keep coming.
//
...
//
// The seed corpus is the RDF 1.1 Turtle suite, whose bad-syntax documents are
...
func FuzzParse(f *testing.F) {
	seeds, err := fuzzcorpus.Seeds(".ttl", "rdf11/rdf-turtle", "rdf12/rdf-turtle")
	if err != nil {
