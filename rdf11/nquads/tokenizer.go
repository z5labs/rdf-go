// This file is a verbatim copy of rdf11/ntriples/tokenizer.go, differing only
...
// grammar (https://www.w3.org/TR/n-quads/#sec-grammar).
type TokenType int
...
// character that begins it. Every terminal of N-Quads is identified by its
