...
// grammar (https://www.w3.org/TR/rdf12-n-triples/#sec-grammar).
type TokenType int
...
const (
	...
	// keyword is case-sensitive — RDF 1.2 N-Triples differs from Turtle here —
...
//
// The keyword is quoted in the grammar and so is case-sensitive: N-Triples
